...
class AddressCoordinateModel {
  AddressCoordinateModel({
      String? status, 
      Input? input, 
      List<Result>? result,}){
    _status = status;
  ...
  AddressCoordinateModel.fromJson(dynamic json) {
    _status = json['status'];
  ...
  Input? _input;
  List<Result>? _result;
AddressCoordinateModel copyWith({  String? status,
  Input? input,
  List<Result>? result,
}) => AddressCoordinateModel(  status: status ?? _status,
  input: input ?? _input,
